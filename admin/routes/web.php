...
Route::middleware('auth')->group(function () {
    ...
    Route::post('stores/become_seller', 'StoreController@becomeSeller')->name('stores.become_seller'); //adeed
    ...
    Route::post('tickets/become_seller', 'TicketController@becomeSeller')->name('tickets.become_seller'); //adeed
    Route::resource('tickets', 'TicketController')->except([
        'show'
    ]);
    ...
    Route::post('sliders/remove-media','SliderController@removeMedia');

    Route::resource('sliders', 'SliderController')->except([
        'show'
    ]);
});
