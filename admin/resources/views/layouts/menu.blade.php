@can('dashboard')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('dashboard*') ? 'active' : '' }}" href="{!! url('dashboard') !!}">@if($icons)
                <i class="nav-icon fa fa-tachometer-alt"></i>@endif
...
@can('fields.index')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('fields*') ? 'active' : '' }}"
           href="{!! route('fields.index') !!}">@if($icons)<i class="nav-icon fa fa-tasks"></i>@endif
            <p>{{trans('lang.field_plural')}}</p></a>
    </li>
@endcan

@can('stores.index')
    <li class="nav-item has-treeview {{ (Request::is('stores*') || Request::is('galleries*') || Request::is('storeReviews*')) && !Request::is('storesPayouts*') ? 'menu-open' : '' }}">
        <a href="#"
           class="nav-link {{ (Request::is('stores*') || Request::is('galleries*') || Request::is('storeReviews*')) && !Request::is('storesPayouts*')? 'active' : '' }}"> @if($icons)
                <i class="nav-icon fas fa-shopping-basket"></i>@endif
        ...
        <ul class="nav nav-treeview">
            @can('stores.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('stores*') ? 'active' : '' }}"
                       href="{!! route('stores.index') !!}">@if($icons)
                            <i class="nav-icon fa fa-shopping-basket"></i>@endif<p>{{trans('lang.store_plural')}}</p></a>
                </li>
            @endcan
            @can('galleries.index')
                <li class="nav-item">
            ...
            @can('storeReviews.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('storeReviews*') ? 'active' : '' }}"
                       href="{!! route('storeReviews.index') !!}">@if($icons)
                            <i class="nav-icon fa fa-comments"></i>@endif<p>{{trans('lang.store_review_plural')}}</p>
                    </a>
                </li>
            @endcan
        </ul>
...
@can('brands.index')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('brands*') ? 'active' : '' }}"
           href="{!! route('brands.index') !!}">@if($icons)
                <i class="nav-icon fa fa-flag"></i>@endif<p>{{trans('lang.brand_plural')}}</p></a>
    </li>
@endcan
...
@can('products.index')
    <li class="nav-item has-treeview {{ Request::is('products*') || Request::is('options*') || Request::is('optionGroups*') || Request::is('productReviews*') || Request::is('nutrition*') ? 'menu-open' : '' }}">
        <a href="#"
           class="nav-link {{  Request::is('products*') || Request::is('options*') || Request::is('optionGroups*') || Request::is('productReviews*') || Request::is('nutrition*') ? 'active' : '' }}"> @if($icons)
        ...
        <ul class="nav nav-treeview">
            @can('products.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('products*') ? 'active' : '' }}"
                       href="{!! route('products.index') !!}">@if($icons)
                            <i class="nav-icon fa fa-archive"></i>@endif
            ...
            @can('optionGroups.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('optionGroups*') ? 'active' : '' }}"
                       href="{!! route('optionGroups.index') !!}">@if($icons)<i
                                class="nav-icon fas fa-plus-square"></i>@endif
                        <p>{{trans('lang.option_group_plural')}}</p></a>
                </li>
            @endcan
            @can('options.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('options*') ? 'active' : '' }}"
                       href="{!! route('options.index') !!}">@if($icons)
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('productReviews*') ? 'active' : '' }}"
                       href="{!! route('productReviews.index') !!}">@if($icons)
                            <i class="nav-icon fa fa-comments"></i>@endif<p>{{trans('lang.product_review_plural')}}</p>
                    </a>
                </li>
            @endcan
...
@can('orders.index')
    <li class="nav-item has-treeview {{ Request::is('orders*') || Request::is('orderStatuses*') || Request::is('deliveryAddresses*')? 'menu-open' : '' }}">
        <a href="#"
           class="nav-link {{ Request::is('orders*') || Request::is('orderStatuses*') || Request::is('deliveryAddresses*')? 'active' : '' }}"> @if($icons)
                <i class="nav-icon fa fa-archive"></i>@endif
        ...
        <ul class="nav nav-treeview">
            ...
            @can('orderStatuses.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('orderStatuses*') ? 'active' : '' }}"
            ...
            @can('deliveryAddresses.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('deliveryAddresses*') ? 'active' : '' }}"
                       href="{!! route('deliveryAddresses.index') !!}">@if($icons)<i
                                class="nav-icon fa fa-map"></i>@endif<p>{{trans('lang.delivery_address_plural')}}</p>
                    </a>
                </li>
            @endcan
...
@can('coupons.index')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('coupons*') ? 'active' : '' }}" href="{!! route('coupons.index') !!}">@if($icons)<i class="nav-icon fa fa-ticket-alt"></i>@endif<p>{{trans('lang.coupon_plural')}} <span class="right badge badge-danger">New</span></p></a>
    </li>
@endcan

@can('tickets.index')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('tickets*') ? 'active' : '' }}" href="{{ url('/tickets') }}">@if($icons)<i class="nav-icon fa fa-ticket-alt"></i>@endif<p>{{trans('lang.ticket_plural')}} <span class="right badge badge-danger">New</span></p></a>
    </li>
@endcan
...
@can('faqs.index')
    <li class="nav-item has-treeview {{ Request::is('faqCategories*') || Request::is('faqs*') ? 'menu-open' : '' }}">
        <a href="#"
           class="nav-link {{ Request::is('faqs*') || Request::is('faqCategories*') ? 'active' : '' }}"> @if($icons)
...
@can('medias')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('medias*') ? 'active' : '' }}" href="{!! url('medias') !!}">@if($icons)<i
                    class="nav-icon fa fa-photo-video"></i>@endif
            <p>{{trans('lang.media_plural')}}</p></a>
    </li>
@endcan

@can('payments.index')
    <li class="nav-item has-treeview {{ Request::is('drivers*') || Request::is('earnings*') || Request::is('driversPayouts*') || Request::is('storesPayouts*') || Request::is('payments*') ? 'menu-open' : '' }}">
        <a href="#"
           class="nav-link {{ Request::is('drivers*') || Request::is('earnings*') || Request::is('driversPayouts*') || Request::is('storesPayouts*') || Request::is('payments*') ? 'active' : '' }}"> @if($icons)
        ...
        <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('payments*') ? 'active' : '' }}"
                       href="{!! route('payments.index') !!}">@if($icons)
                            <i class="nav-icon fas fa-money-check-alt"></i>@endif<p>{{trans('lang.payment_plural')}}</p></a>
                </li>
            @endcan
            @can('drivers.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('drivers*') ? 'active' : '' }}"
                       href="{!! route('drivers.index') !!}">@if($icons)<i class="nav-icon fas fa-car"></i>@endif
                        <p>{{trans('lang.driver_plural')}} <span class="right badge badge-danger">New</span></p></a>
                </li>
            @endcan
            ...
            @can('earnings.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('earnings*') ? 'active' : '' }}"
                       href="{!! route('earnings.index') !!}">@if($icons)<i class="nav-icon fas fa-file-invoice-dollar"></i>@endif
                        <p>{{trans('lang.earning_plural')}} <span class="right badge badge-danger">New</span></p></a>
                </li>
            @endcan

            @can('driversPayouts.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('driversPayouts*') ? 'active' : '' }}"
                       href="{!! route('driversPayouts.index') !!}">@if($icons)<i
                                class="nav-icon fas fa-money-bill-wave"></i>@endif<p>{{trans('lang.drivers_payout_plural')}}</p>
                    </a>
                </li>
            @endcan
            ...
            @can('storesPayouts.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('storesPayouts*') ? 'active' : '' }}"
                       href="{!! route('storesPayouts.index') !!}">@if($icons)<i
                                class="nav-icon fas fa-money-bill-wave"></i>@endif<p>{{trans('lang.stores_payout_plural')}}</p>
                    </a>
                </li>
            @endcan
...
@can('app-settings')
    <li class="nav-item has-treeview {{ Request::is('settings/mobile*') ? 'menu-open' : '' }}{{ Request::is('sliders*') ? 'menu-open' : '' }}">
        <a href="#"
           class="nav-link {{ Request::is('settings/mobile*') ? 'active' : '' }}{{ Request::is('sliders*') ? 'active' : '' }}">
            @if($icons)<i class="nav-icon fas fa-mobile"></i>@endif
            <p>
            ...
            <li class="nav-item">
                <a href="{!! url('settings/mobile/colors') !!}"
                   class="nav-link {{  Request::is('settings/mobile/colors*') ? 'active' : '' }}">
                    @if($icons)<i class="nav-icon fas fa-magic"></i> @endif <p>{{trans('lang.mobile_colors')}}</p>
                </a>
            </li>

            <li class="nav-item">
                <a class="nav-link {{ Request::is('sliders*') ? 'active' : '' }}" href="{!! route('sliders.index') !!}">@if($icons)<i
                            class="nav-icon fas fa-images"></i>@endif<p>{{trans('lang.slider_plural')}}</p></a>
            </li>
    ...
    (Request::is('settings*') ||
     Request::is('users*')) && !Request::is('settings/mobile*')
        ...
        <ul class="nav nav-treeview">
            ...
            @can('users.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('settings/users*') ? 'active' : '' }}"
            ...
            <li class="nav-item">
                <a href="{!! url('settings/app/localisation') !!}"
                   class="nav-link {{  Request::is('settings/app/localisation*') ? 'active' : '' }}">
                    @if($icons)<i class="nav-icon fas fa-language"></i> @endif
                    <p>{{trans('lang.app_setting_localisation')}}</p></a>
            </li>
            <li class="nav-item">
                <a href="{!! url('settings/translation/en') !!}"
                   class="nav-link {{ Request::is('settings/translation*') ? 'active' : '' }}">
                    @if($icons) <i class="nav-icon fas fa-language"></i> @endif
                    <p>{{trans('lang.app_setting_translation')}}</p></a>
            </li>
            @can('currencies.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('currencies*') ? 'active' : '' }}"
                       href="{!! route('currencies.index') !!}">@if($icons)<i class="nav-icon fas fa-dollar-sign"></i>@endif
                        <p>{{trans('lang.currency_plural')}}</p></a>
                </li>
            @endcan

            <li class="nav-item">
                <a href="{!! url('settings/app/payment') !!}"
                   class="nav-link {{  Request::is('settings/app/payment*') ? 'active' : '' }}">
