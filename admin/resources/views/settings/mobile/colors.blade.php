        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="form-group row col-6">
                    ...
                    <div class="col-8">
                        <div id="main-colorpicker" class="input-group colorpicker-component">
                            {!! Form::text('main_color', setting('main_color',"#22B7CE"),  ['class' => 'form-control','placeholder'=>  trans("lang.app_setting_main_color_placeholder"),'autocomplete' => 'off']) !!}
                            <div class=" input-group-append ">
                                <span class="input-group-addon input-group-text"><i class="fas fa-square" style="color: {!! setting('main_color',"#22B7CE") !!}"></i></span>
                            </div>
                        </div>
                ...
                <div class="form-group row col-6">
                    ...
                    <div class="col-8">
                        <div id="main-colorpicker" class="input-group colorpicker-component">
                            {!! Form::text('main_dark_color', setting('main_dark_color',"#22B7CE"),  ['class' => 'form-control','placeholder'=>  trans("lang.app_setting_main_dark_color_placeholder"),'autocomplete' => 'off']) !!}
                            <div class=" input-group-append ">
                                <span class="input-group-addon input-group-text"><i class="fas fa-square" style="color: {!! setting('main_color',"#22B7CE") !!}"></i></span>
                            </div>
                        </div>
