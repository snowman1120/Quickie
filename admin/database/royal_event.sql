...
CREATE TABLE `eventData`(
  `ID` int(10) NOT NULL,
  `ticketname` varchar(120) DEFAULT NULL,
  `description` varchar(255) DEFAULT NULL,
  `eventStartDate` varchar(120) DEFAULT NULL,
  `eventEndDate` varchar(120) DEFAULT NULL,
  `starttime` varchar(120) DEFAULT NULL,
  `endtime` varchar(120) DEFAULT NULL,
  `venue` varchar(255) DEFAULT NULL,
  `gender` varchar(255) DEFAULT NULL,
  `ticketfile` varchar(255) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `filetype` varchar(255) DEFAULT NULL,
  `ticketcount` int(255) DEFAULT 1
