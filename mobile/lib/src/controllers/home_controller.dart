...
class HomeController extends ControllerMVC {
  ...
  Future<void> listenForCategories() async {
    ...
    // Add ticket at first position
    categories.add(getTicketCategory());
  ...
  Category getTicketCategory() {
    ...
    category.description = '<p>Tickets<br></p>';
    category.imageUrl =
        '${GlobalConfiguration().getValue('base_url')}../storage/app/ticket/image/${setting.value.ticketCategoryPhoto}';
