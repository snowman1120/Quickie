...
class S {
  ...
  String get search_for_stores_or_products {
    return Intl.message(
      'Search for stores or products',
  ...
  String get not_a_valid_address_description {
    return Intl.message(
      'Not a valid address Description',
      name: 'not_a_valid_address_description',
      desc: '',
      args: [],
    );
  }
  ...
  String get the_product_was_removed_from_your_favorite {
    return Intl.message(
      'The \$productName was removed from your favorite',
      name: 'the_product_was_removed_from_your_favorite',
      desc: '',
      args: [],
    );
  }
  ...
  String get brand_refreshed_successfuly {
    return Intl.message(
      'Brand refreshed successfully',
      name: 'brand_refreshed_successfuly',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Tell us about this srore`
  String get tell_us_about_this_store {
    return Intl.message(
      'Tell us about this srore',
      name: 'tell_us_about_this_store',
      desc: '',
      args: [],
    );
  }
  ...
  String get how_would_you_rate_this_store_ {
    return Intl.message(
      'How would you rate this store ?',
      name: 'how_would_you_rate_this_store_',
      desc: '',
      args: [],
    );
  }
  ...
  String get the_store_has_been_rated_successfully {
    return Intl.message(
      'The store has been rated successfully',
      name: 'the_store_has_been_rated_successfully',
      desc: '',
      args: [],
    );
  }
  ...
  String get stores_near_to_your_current_location {
    return Intl.message(
      'Stores near to your current location',
      name: 'stores_near_to_your_current_location',
      desc: '',
      args: [],
    );
  }
  ...
  String get this_store_is_closed_ {
    return Intl.message(
      'This store is closed !',
      name: 'this_store_is_closed_',
      desc: '',
      args: [],
    );
  }
  ...
  /// `How would you rate this store ?`
  String get how_would_you_rate_this_store {
    return Intl.message(
      'How would you rate this store ?',
      name: 'how_would_you_rate_this_store',
      desc: '',
      args: [],
    );
  }
  ...
  String get your_phone_and_address_book_are_used_to_connect {
    return Intl.message(
      'Your phone and address book are used to connect. Call you to verify your phone Number',
      name: 'your_phone_and_address_book_are_used_to_connect',
      desc: '',
      args: [],
    );
  }
  ...
  String get this_notification_was_removed {
    return Intl.message(
      'This notification was removed',
      name: 'this_notification_was_removed',
      desc: '',
      args: [],
    );
  }
  ...
  String get click_to_pay_with_razorpay_method {
    return Intl.message(
      'Click to pay with RazorPay method',
      name: 'click_to_pay_with_razorpay_method',
      desc: '',
      args: [],
    );
  }
  ...
  String get search_for_tickets {
    return Intl.message(
      'Search for tickets',
      name: 'search_for_tickets',
      desc: '',
      args: [],
    );
  }

  /// `This ticket was added to cart`
  String get this_ticket_was_added_to_cart {
    return Intl.message(
      'This ticket was added to cart',
      name: 'this_ticket_was_added_to_cart',
      desc: '',
      args: [],
    );
  }

  /// `The $ticketName was removed from your favorite`
  String get the_ticket_was_removed_from_your_favorite {
    return Intl.message(
      'The \$ticketName was removed from your favorite',
      name: 'the_ticket_was_removed_from_your_favorite',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Featured Products`
  String get featured_tickets {
    return Intl.message(
      'Featured Tickets',
      name: 'featured_tickets',
      desc: '',
      args: [],
    );
  }
